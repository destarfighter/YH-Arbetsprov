...
/// <summary>
/// Animates a pathfinder-solution by showing the search-pattern, then displaying the path. 
/// </summary>
...
public:
	void initialize(const int tilesetResource, std::vector<TileFrame> searchAnimation, std::vector<unsigned long int> pathAnimation);
